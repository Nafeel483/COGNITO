...
class EditFlashBack extends Component {
  constructor(props) {
    super(props);
      ...
      <>
        <Grid container>
          ...
          <Grid item xs={12} md={2}>
            <Typography className={classes.editFlashCard} variant="h5">Edit Flashcards</Typography>
          </Grid>
...
export default withRouter(withStyles(styles)(EditFlashBack))
