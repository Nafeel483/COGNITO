        ...
        <Grid container className={classes.folderChipWrapper} >
          <Grid item xs={3} className={classes.folderIconWrapper}>
            <img
              src={folder.image}
              style={{
                width: folder.title == "Subfolder" ? "45px" : folder.title == "Flashcards" ? '26px' : folder.title == "Assessments" ? '28px' : '23px',
                height: folder.title == "Subfolder" ? "30px" : folder.title == "Flashcards" ? '26px' : folder.title == "Assessments" ? '34px' : '28px'
              }}
            />
            <Typography
