...
import EditFolderDialog from "../../Folders/CreateFolder/EditFolderDialog";
...
export default TableFolderChip;
...
const useStyles = makeStyles((theme) => ({
  ...
  iconInnerWrapper: {
    padding: 20,
    borderRadius: '50%',
    background: colors.lowOpacityPrimary
  }
}));
